...
type Demultiplexer interface {
	...
	Serializer() serializer.MetricSerializer // XXX(remy): remove me
...
// InitAgentDemultiplexer creates a new Demultiplexer
...
func InitAgentDemultiplexer(options DemultiplexerOptions, hostname string) *AgentDemultiplexer {
	...
	if demultiplexerInstance != nil {
		log.Warn("A DemultiplexerInstance is already existing but InitAgentDemultiplexer has been called again. Current instance will be overridden")
	}
...
// InitServerlessDemultiplexer creates a new Demultiplexer for the serverless agent
// TODO(remy): finish this comment
func InitServerlessDemultiplexer(keysPerDomain map[string][]string, hostname string, forwarderTimeout time.Duration) *ServerlessDemultiplexer {
